...
/**
  ...
  *
  * @checksum - ddab96a0bfc003d0ca40ced0ac998a53772f8a3dfdc59fd76a6efd716d46c6a4
  * @variables - radius=rounded-lg,accentColor=teal,colorTemperature=zinc,spacing=2,scale=base,inputShadow=shadow-md,baseColorShade=600,borderShadeLightMode=400,borderShadeDarkMode=500,inputMaxWidth=max-w-[20em],tagRadius=rounded,swatchRadius=rounded
  * @theme - regenesis
  **/
